(function() {
	...
	this.livingdocs.watson.templates = (function() {
		return {
			...
			text_1: _.template("<p data-doc-editable=\"text\">«Reiche Leistungsträger verstecken ihr Geld im Ausland, weil sie die deutschen Steuergesetze offenbar als ungerecht oder als zu belastend empfinden», sagt Roger Köppel, Chefredaktor und Verleger der «Weltwoche». «Die Schweizer sollten uns nicht belehren, wie unsere Steuersätze aussehen müssten», kontert Hans Leyendecker, renommierter Investigativjournalist der «Süddeutschen Zeitung». Und mit unterschiedlichsten Ansichten geht es rasant weiter im Interviewduell, das Leyendecker und Köppel für Tagesanzeiger.ch/Newsnet geführt haben. Aber lesen Sie selbst, was die beiden bekannten Journalisten zum geplanten Steuerabkommen und den jüngsten Turbulenzen zwischen der Schweiz und Deutschland meinen.</p>"),
			...
			text_2: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>Roger Köppel:</strong> Das sind politische Überlegungen, die eine Bundesanwaltschaft nicht beirren dürfen. Die Bundesanwaltschaft ist eine unabhängige Behörde, die nach rechtlichen Kriterien handelt. Jedenfalls handeln sollte.</p>"),
			text_3: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>Hans Leyendecker:</strong> Es wäre töricht, auf törichte Haftbefehle mit Anzeigen zu reagieren. In diesem Fall sitzt niemand am längeren Hebel. Aber mancher gräbt sich seine Grube selbst.</p>"),
			...
			text_4: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>RK:</strong> Das müssen die Untersuchungen zeigen, aber wirtschaftlicher Nachrichtendienst – Spionage – dürfte auch nach deutschem Recht verboten sein.</p>"),
			text_5: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>HL:</strong> Die Schweizer verweisen zu Recht auf ihr Strafgesetz. Aber auch das Gesetz gibt die Vorwürfe gegen die Steuerfahnder nicht her. Da ist kein dringender Tatverdacht; nur sehr forsche Ermittler könnten einen sehr dünnen Anfangsverdacht vermuten. Sie müssten aber die Unschuldsvermutung stark herausstellen. Den Steuerfahndern sind die Daten angeboten worden. Spionage funktioniert anders.</p>"),
			...
			text_8: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>RK:</strong> Dahinter steckt die Verabsolutierung des eigenen Standpunkts. Es ist wie bei Kindern, die nicht einsehen können, dass ihre Wünsche nicht automatisch verpflichtend sind für andere Menschen. </p>"),
			text_9: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>HL:</strong> Die Haftbefehle sind am 15. März, also auf dem vorläufigen Höhepunkt der deutschen Diskussion über das Steuerabkommen, ausgestellt worden. Zufall? Die Verfolgung solcher angeblicher Straftaten bedarf in der Schweiz einer Ermächtigung durch den Bundesrat. Die hat es in diesem Fall gegeben. Zufall?</p>"),
			...
			text_10: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>RK:</strong> Ja.</p>"),
			text_11: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>HL:</strong> Wer Steuern hinterzieht und Schwarzgeld ins Ausland schafft, ist kriminell und schädigt das Gemeinwohl. Die Schweizer sollten uns nicht belehren, wie unsere Steuersätze aussehen müssten.</p>"),
			...
			text_12: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>RK:</strong> Deutschland hat 2000 Milliarden Schulden. Deutschland will nicht wirklich sparen, sondern immer mehr Geld an Steuern erheben. Es ist kein Wunder, dass diese Politik das Vertrauen der leistungsfähigen Bürger in den deutschen Staat erschüttert. Solange die verfehlte Schulden- und Steuerpolitik anhält, wird es immer Deutsche geben, die ihr Geld in Sicherheit bringen wollen.</p>"),
			text_13: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>HL:</strong> Warum sind in der Schweiz eigentlich die Schweizer Steuerhinterzieher kein grosses Thema? So soll etwa ein Drittel der Schwarzgelder auf Vaduzer Konti aus der Schweiz stammen. Egal, illegal...?</p>"),
			...
			text_14: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>RK:</strong> Sicher nicht schlechter</p>"),
			text_15: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>HL:</strong> Das vorliegende Abkommen ist aus deutscher Sicht nicht zu akzeptieren. Notorische Steuerhinterzieher würden belohnt. Wie die Schweiz das Abkommen sieht, ist Schweizer Sache.</p>"),
			...
			text_16: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>RK:</strong> In Deutschland entscheidet der Staat, wie viel Geld er den Bürgern abnimmt. In der Schweiz entscheiden die Bürger, wie viel Geld sie dem Staat geben wollen. Das ist der Unterschied.</p>"),
			text_17: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>HL:</strong> Das Bankgeheimnis ist kein Fetisch. Es gibt Wichtigeres, selbst in der Schweiz.</p>"),
			...
			text_18: _.template("<p data-doc-editable=\"text\" class=\"statement contra\"><strong>RK:</strong> Es ist nicht Sache der Schweiz, jeden Hotelgast, jeden Uhrenkäufer oder jeden Bankkunden auf seine Steuerehrlichkeit hin zu durchleuchten. Wenn die Deutschen ein Problem haben, dass niemand die Steuern bezahlt, dann müssen sie dieses Problem lösen. Die Schweiz ist ein unabhängiges Land, keine Unterabteilung der deutschen Steuerpolizei.</p>"),
			text_19: _.template("<p data-doc-editable=\"text\" class=\"statement pro\"><strong>HL:</strong> Von aussen betrachtet findet in der Schweiz ein Machtkampf statt. Sie sollten von dem Nachbarn Liechtenstein lernen, wie man einen Neuanfang startet.</p>"),
			
				
			image_1: _.template("<img src=\"media/img/placeholderimg/bild_052.jpg\" />"),
			image_2: _.template("<img src=\"media/img/placeholderimg/bild_053.jpg\" />"),
			...
			tagList: _.template("<div class='tags'>Artikel-Tags<ul><li class='ressort'><a href='#'>Wirtschaft</a></li><li><a href='#'>Steuerabkommen</a></li><li><a href='#'>Roger Köppel</a></li><li><a href='#'>Hans Leyendecker</a></li><li><a href='#'>Pro und Contra</a></li></ul></div>"),
