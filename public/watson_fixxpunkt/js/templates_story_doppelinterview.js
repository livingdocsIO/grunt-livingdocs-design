(function() {
	...
	this.livingdocs.watson.templates = (function() {
		return {
			...
			text_2: _.template("<p data-doc-editable=\"text\"><strong>Guy Morin:</strong> Basel und Zürich haben ein grosses Interesse daran, der Schweiz zu zeigen, dass sie Lösungen für aktuelle Probleme parat haben. Die Städte sind die Innovationszentren der Schweiz, der Entwicklungsmotor.</p>"),
			...
			text_3: _.template("<p data-doc-editable=\"text\"><strong>Corine Mauch:</strong> In der Bevölkerung ist das Unbehagen gegen die bisherige, wenig griffige Raumplanung weit verbreitet. Das hat auf nationaler Ebene das Ja zur Zweitwohnungs-Initiative gezeigt und auf kantonaler Ebene die Kulturlandinitiative. Verdichtetes Bauen ist wichtig. Und die Städte machen dies schon vor.</p>"),
			text_4: _.template("<p data-doc-editable=\"text\"><strong>Morin:</strong> Wir können der Bevölkerung zeigen, dass verdichtetes Bauen in den Städten zu einer Verbesserung der Lebensqualität führt.</p>"),
			...
			text_5: _.template("<p data-doc-editable=\"text\"><strong>Mauch:</strong> Im privaten Sektor sind die Mieten teilweise sehr hoch. In Zürich haben wir aber auch die einmalige Situation, dass 25 Prozent des Mietwohnungsbestands gemeinnütziger Wohnungsbau sind. Und hier gibt es preiswerte Angebote. Die Frage lautet: Kommen auch die richtigen Leute zu diesen Wohnungen?</p>"),
			text_6: _.template("<p data-doc-editable=\"text\"><strong>Morin:</strong> In Basel wollen wir den Anteil an gemeinnützigem Wohnungsbau erhöhen. Hier können wir viel von Zürich lernen. Zürich kann aber auch viel von Basel lernen, etwa in den Bereichen Energie und Verkehr. . .</p>"),
			...
			text_7: _.template("<p data-doc-editable=\"text\"><strong>Morin:</strong> Die Alternative wäre, dass die Landschaft zersiedelt würde. Dies wiederum hätte eine verstärkte Mobilität zur Folge. Der Weg zum Arbeitsplatz würde länger, was zu überfüllten Zügen und Staus auf der Autobahn führen würde. Das Raumplanungsgesetz ist auch eine ökologische Lösung. </p>"),
			...
			text_8: _.template("<p data-doc-editable=\"text\"><strong>Mauch:</strong> Ja, die Städte machen das ja auch schon. In Zürich gibt es keine Baulandreserven mehr. Auch die Industriebrachen sind mittlerweile verplant und verbaut. Wir sind jetzt damit konfrontiert, wie wir die Zentren weiterentwickeln wollen. Eine gute Stadtentwicklung führt dazu, dass die Lebensqualität auch bei verdichtetem Bauen bestehen bleibt. Die Plakate der Gegner mit dem Slogan «Horror-Mieten auf engstem Raum» sind deshalb Unsinn und absurd. Die Qualität und nicht einfach die Quantität muss im Vordergrund stehen.</p>"),
			...
			text_12: _.template("<p data-doc-editable=\"text\"><strong>Morin:</strong> Vor zehn Jahren hatten wir die Stadtflucht. Heute erleben wir den Gegentrend. Viele Menschen wollen wieder in der Stadt leben. Wegen der kurzen Wege zum Arbeitsplatz, zum Einkaufen, zur Freizeit. Wegen der Kultur. Damit ist die Stadt gefordert und wir müssen dem Bedürfnis nach genügend Wohnraum gerecht werden. Die Grünflächen auf dem Land wollen wir als Erholungsgebiet erhalten. Die Städte sind schon lange nicht mehr die Problemzonen der Schweiz.</p>"),
			text_13: _.template("<p data-doc-editable=\"text\"><strong>Mauch:</strong> Ihre These wird Tag für Tag widerlegt. 2011 sind über 4500 zusätzliche Leute nach Zürich gezogen. Die Leute sind nicht scharf auf Zersiedlung, sie wollen abends nicht im Stau stehen.</p>"),
			...
			text_14: _.template("<p data-doc-editable=\"text\"><strong>Morin:</strong> Für die Stadt und ihre Bewohner ist es nur von Vorteil, wenn das Steuersubstrat wächst. Mehrinvestitionen, die der Lebensqualität von uns allen zugutekommen, sind immer willkommen.</p>"),
			
			half_title_9: _.template("<p data-doc-editable=\"text\" class=\"half_title\">Das wird aber so nicht deklariert.</p>"),
			text_15: _.template("<p data-doc-editable=\"text\"><strong>Morin:</strong> Es ist ein Ziel. Es darf aber nicht sein, dass wir nur für die Reichen bauen. Wir bauen für die ganze Bevölkerung, für alle Bedürfnisse, in allen Grössen- und Preislagen. Die Alteingesessenen sollen nicht das Gefühl haben, sie würden verdrängt. Das ist auch das Ziel unseres neuen Wohnfördergesetzes.</p>"),
			text_16: _.template("<p data-doc-editable=\"text\"><strong>Mauch:</strong> Mit dem Wachstum brauchen wir mehr öffentlichen Verkehr, Schulhäuser, ausserfamiliäre Kinderbetreuung. Das kostet alles. Wir brauchen die Mehreinnahmen. Sie sind aber nicht der Hauptgrund für unser Engagement.</p>"),
			...
			text_17: _.template("<p data-doc-editable=\"text\"><strong>Mauch:</strong> Nein, die Steuern sind in der Schweiz immer gekoppelt an die demokratische Mitsprache und wir haben den Finanzausgleich. Ich finde dieses System gut. Die Zentrumslasten der Städte sind aber noch nicht in ausreichendem Mass abgegolten. Hier haben wir ein massives Ungleichgewicht. Das muss behoben werden.</p>"),
			text_18: _.template("<p data-doc-editable=\"text\"><strong>Morin:</strong> Gebietsreformen bringen mehr. Gingen die Kantone Baselland und Basel-Stadt zusammen, würden die Landschäftler auch mehr an die Zentrumslasten zahlen. Von den 35 000 Grenzgängern aus Frankreich und Deutschland beziehen wir heute eine Quellensteuer, von den 45 000 Baselbieter Pendlern erhalten wir nichts. Deshalb pushen wir auch die Fusion von Baselland und Basel-Stadt. Zürich könnte ja mit Zug fusionieren (lacht).</p>"),
			text_19: _.template("<p data-doc-editable=\"text\"><strong>Mauch:</strong> (lacht) Das ist dein Vorteil. Du bist sowohl Stadt- als auch Regierungspräsident.</p>"),
