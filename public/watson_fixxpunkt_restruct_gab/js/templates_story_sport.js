(function() {
	...
	this.livingdocs.watson.templates = (function() {
		return {
			...
			headerImage: _.template("<img  class='hide_on_mobile'  src=\"media/img/placeholderimg/bild_021.jpg\" /><img class='hide_on_desktop show_on_mobile' src=\"media/img/placeholderimg/bild_054.jpg\" />"),
			...
			upperLine: _.template("<h3 class='uppertitle'>Super League</h3>"),
			title: _.template("<h2 data-doc-editable=\"title\" class='maintitle'>Thuner lassen dem FC&nbsp;St.&nbsp;Gallen keine Chance</h2>"),
			...
			image_1: _.template("<img style='width:100%;' src='media/img/placeholderimg/bild_022.jpg' />"),
			...
			panorama: _.template("<div class='widget panorama color_combo_12'><img src='media/img/placeholderimg/bild_020.jpg' /><p><span class='combo_bg'></span><span class='combo_fg'>- Das Panorama im Panorama -</span></p></div>"),
			...
			tagList: _.template("<div class='widget tags'><div class='title'>Artikel-Tags</div><ul><li class='ressort'><a href='#'>Fussball</a></li><li><a href='#'>FC Thun</a></li><li><a href='#'>FC St. Gallen</a></li><li><a href='#'>Super League</a></li></ul></div>")
		};
	})();
