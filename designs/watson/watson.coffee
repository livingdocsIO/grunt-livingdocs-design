...
@livingdocs.watson.templates = do ->


  # layout elements
  # ================
  fullWidthLayout: _.template(
    """
    <div class="wrapper">
  ...
  # ================
  # images
  headerImage: _.template(
    """
    <img class="illu" src="https://www.fixxtest.ch/showcase/media/img/placeholderimg/bild_018.jpg" />
    """
  )
  ...
  image: _.template(
    """
    <img src="https://www.fixxtest.ch/showcase/media/img/placeholderimg/bild_019.jpg" />
    """
  )
  ...
  caption: _.template(
    """
    <p data-doc-editable="text" class="caption">Mobutu, König von Zaire 3: Das Ende der Herrschaft</p>
    """
  )
  ...
  lead: _.template(
    """
    <p class="lead" data-doc-editable="text">
  ...
  title: _.template(
    """
    <h2 data-doc-editable="title">Afrikas krankes Herz</h2>
    """
  )
  ...
  subtitle: _.template(
    """
    <p data-doc-editable="title" class="half_title">Teile und hersche</p>
    """
  )
  ...
  quote: _.template(
    """
    <p class="quote" data-doc-editable="text">
  ...
  author: _.template(
    """
    <p data-doc-editable="text" class="author">
      Daniel Huber
    </p>
    """
  )
  ...
  date: _.template(
    """
    <p data-doc-editable="date" class="date">22. Mai 2013 15:45</p>
    """
  )
  ...
  source: _.template(
    """
    <p data-doc-editable="text" class="source">Paul Rusesabagina, 1994 Direktor Hotel Des Mille Collines, Kigali,Ruanda</p>
    """
  )


  # inserts
  rightInsert: _.template(
    """
      <div class="insert">
      </div>
    """
  ...
  # TODO is this an insert or an imagebar?
  imageBar: _.template(
    """
    <div class="insert full imagebar">
    </div>
    """
  )


  sideInsert: _.template(
    """
    <div class="insert side">
    </div>
    """
  )


  # TODO: it's not clear how the social media box relates to the layout => find something better
  socialMediaBox: _.template(
    """
    <div class="social_box hide_on_mobile">
